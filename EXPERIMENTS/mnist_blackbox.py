...
if __name__ == '__main__':
    ...
    debugNumEpochs = 1 #DEBUGGING
    debugDataAug = 1 #DEBUGGING
    # General flags
    ...
    flags.DEFINE_integer('nb_epochs', debugNumEpochs, 'Number of epochs to train model')
    #flags.DEFINE_integer('nb_epochs', 10, 'Number of epochs to train model')

    # Flags related to substitute
    flags.DEFINE_integer('holdout', 150, 'Test set holdout for adversary')
    flags.DEFINE_integer('data_aug', debugDataAug, 'Nb of substitute data augmentations')
    #flags.DEFINE_integer('data_aug', 6, 'Nb of substitute data augmentations')
    flags.DEFINE_integer('nb_epochs_s', debugNumEpochs, 'Training epochs for substitute')
